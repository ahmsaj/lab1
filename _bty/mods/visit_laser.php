...
<header>
	<div class="top_txt_sec fl cbg44">
        ...
        <div class="fl">
			...
			<div class="fs14 f1 lh20" fix="h:25"><?=$clinc_name?><ff> ( <?=$clinc_code?> ) </ff><span id="d1"></span></div>
        </div>
    </div>	
...
$(document).ready(function(e){<?=$clinicCode[$mood]?>_vit_d_ref(1);refPage('bty1',10000);});</script>