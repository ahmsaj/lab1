...
3:حاجز الموعد:p61:_users^id^name_(L)^where `grp_code` IN(\'pfx33zco65\',\'nlh8spit9q\',\'9k0a1zy2ww\')|
3:'.k_insure_comp.':pIns:gnr_m_insurance_prov^id^name_(L)^|';
if(!in_array($thisGrp,array('9k0a1zy2ww'))){$customFiltter.="3:".k_dr.":p7:_users^id^name_(L)^where `grp_code` IN('9k0a1zy2ww')|";}
$customFiltter.='3:'.k_clinic.':p8:gnr_m_clinics^id^name_(L)^where type =7 |
4:'.k_status.':p9:'.getModParAsList('tug0r81upf').'|
4:'.k_pay_type.':p11:'.getModParAsList('n86k4sdvd').'|
6:'.k_urgent.':p12|
';
$customPageFiltter='osc_acc_visit_review';?>
