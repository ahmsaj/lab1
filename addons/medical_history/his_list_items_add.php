...
if(isset($_POST['vis'],$_POST['id'],$_POST['itId'])){
	...
	if($r['r']){
		...
		if($r['r']){
			...
			<form name="mHis" id="mHis" action="'.$addPath3.'his_list_items_save.php" method="post"  cb="viewMHis()">
				...
				echo '<tr><td n></td>
					<td i><div class="fl ic40 icc2 ic40_save ic40Txt" id="saveHis">'.k_save.'</div></td></tr>
				</table>
			</form>';
		}		
	}
