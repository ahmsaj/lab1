...
if(isset($_POST['vis'])){
	$id=pp($_POST['vis']);	
	$r2=getRecCon('cln_m_addons'," code='$vsCode' and act=1" );
	...
	if($r['r'] && $r2['r']){
		...
		<div class="fl w100 lh40 cbg444 b_bord f1" id="vs_ItTot"></div>
		<div class="fl ofx so pd10f prvTpmlist" id="vs_ItData" fix="hp:117|wp:0" actButt="act"></div><?
	}
}?>